...
投稿 → Post2RW (train4.py) → 推定 RW 集合
→ Attention CLS‐Pooling → MLP → 真 RW
"""

import os, csv, random, pickle, importlib.util
import numpy as np
...
# Post→RW モデル定義 & 重み
POST2RW_PY   = os.path.join(TRAIN_DIR, "train4.py")   # ← ここを固定
